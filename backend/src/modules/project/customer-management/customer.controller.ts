...
import { CustomerListWithSummaryResponseDto } from './dto/customer-response.dto';
...
export class CustomerController {
  ...
  @ApiCreatedResponse({ description: '등록 성공', type: CustmerDto })
  ...
  @ApiOkResponse({ description: '상세 정보 조회 성공', type: CustmerDto })
