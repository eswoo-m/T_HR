/*
  ...
  - You are about to drop the `Pre_project_assignment` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "Pre_project_assignment" DROP CONSTRAINT "Pre_project_assignment_employee_id_fkey";

-- DropTable
DROP TABLE "Pre_project_assignment";
